...
def build_simple_vte_model_relu(premise_input,
                                hypothesis_input,
                                img_features_input,
                                dropout_input,
                                num_tokens,
    ...
    premise_hidden_layer = tf.nn.dropout(
        tf.contrib.layers.fully_connected(premise_final_states.h, multimodal_fusion_hidden_size),
        keep_prob=dropout_input
    )
    ...
    premise_img_multimodal_fusion = tf.multiply(premise_hidden_layer, img_hidden_layer)
...
if __name__ == "__main__":
    ...
    logits = build_simple_vte_model_relu(
        premise_input,
        hypothesis_input,
        img_features_input,
        dropout_input,
